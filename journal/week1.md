...
Click on the frontend URL and you will see the Cruddur application.  We now have access to the web application.  The frontend and backend can communicate with each other.
